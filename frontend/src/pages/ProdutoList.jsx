...
const renderMobileCard = (produto) => (
  <Card key={produto.id} sx={{ mb: 2, elevation: 2 }}>
    <CardContent sx={{ p: 2 }}>
      {/* Cabeçalho do Card: Imagem e Título */}
      <Box
        sx={{
          display: 'flex',
      ...
      {/* Corpo do Card: Descrição e Valor */}
      <Box sx={{ mb: 2 }}>
        <Box sx={{ mb: 1 }}>
...
return (
  <PageLayout title="Produtos" actions={actions}>
    {/* Visão Desktop: Tabela oculta em telas extra-pequenas (xs), visível em médias (md) */}
    ...
    {/* Visão Mobile: Cards visíveis em telas pequenas (xs), ocultos em médias (md) */}
